#Yeni Asır Front page webscraper
#Yeni Asır is a Turkish Newspaper
...
class YeniAsir:
    ...
    def download_date(self, date: datetime.datetime):
        if date < self.start_date or date > self.today:
            ...
            month = date.month
            year = date.year
            website = f"https://egazete.yeniasir.com.tr/eGazete/image/www_yeniasir_com_tr/{year}/{month}/{day}/1"
    ...
    #This method will download of Yeni Asır's front page archive from the 1st January 2021 till today
    ...
    # The following method will check a particular date to check if it has been downloaded or nor
...
if __name__ == "__main__":
    yeniasir = YeniAsir()
    yeniasir.download_d1_d2(d1=datetime.datetime(day=5,month=5,year=2022),d2=yeniasir.today)
