#Takvim Front page webscraper
#Takvim is a famous Turkish Newspaper
...
class Takvim:
    ...
    def download_date(self, date: datetime.datetime):
        if date < self.start_date or date > self.today:
            ...
            month = date.month
            year = date.year
            website = f"http://egazete.takvim.com.tr/eGazete/image/www_takvim_com_tr/{year}/{month}/{day}/1"
    ...
    #This method will download of Takvim's front page archive from the 1st January 2021 till today
...
if __name__ == "__main__":
    takvim = Takvim()
    takvim.download_d1_d2(d1=datetime.datetime(day=17,month=1,year=2022),d2=takvim.todayz)